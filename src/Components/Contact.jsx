...
const Contact = () => {
  return (
    <section id="contact" className="bg-gray-900 text-white py-16 px-6 md:px-20 min-h-screen">
            <motion.div
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition">
              ...
              <div>
                ...
                <a href="mailto:hebaabdelaall75@gmail.com" className="text-gray-300 hover:text-indigo-400 transition">
               hebaabdelaall75@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition">
              ...
              <div>
                ...
                <a href="tel:+201016274775" className="text-gray-300 hover:text-green-400 transition">
                  +201016274775
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transition">
              <a href="https://www.facebook.com/heba.a.tarakhan.2025" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition text-3xl">
                <FaFacebook />
              </a>
              <a href="https://www.linkedin.com/in/heba-abdelaal-1a3965195/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition text-3xl">
                <FaLinkedin />
              </a>
              <a href="https://github.com/Hebaabdelaal1" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition text-3xl">
                <FaGithub />
              </a>
            </div>
          </div>
